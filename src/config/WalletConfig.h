...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "GhosT";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "GhosT";
    ...
    const std::string daemonName = "GhosTCoind";
    ...
    const std::string contactLink = "http://chat.samsungplanet.com";
